...
const char *cmd_set_state_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-aod-on-command-1-state",
	"qcom,mdss-dsi-aod-on-command-2-state",
	"qcom,mdss-dsi-aod-on-command-3-state",
	"qcom,mdss-dsi-aod-on-command-4-state",
	"qcom,mdss-dsi-aod-on-command-5-state",
